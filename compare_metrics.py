...
def compare_metrics(new_metrics_path, prod_metrics_path):
    ...
    Exits with 0 if the new model is better, 1 otherwise.
    """
    ...
    # We'll use accuracy as the key metric for promotion.
    ...
    if new_accuracy > prod_accuracy:
        ...
        print("New model is NOT better than production. Skipping deployment.")
